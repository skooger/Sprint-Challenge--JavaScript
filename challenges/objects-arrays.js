...
const tyrannosaurus = makeDinosaurObj("tyrannosaurus","carnivorous","7000kg","12m","Late Cretaceous");

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = makeDinosaurObj("stegosaurus","herbivorous","2000kg","9m","Late Jurassic");
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor = makeDinosaurObj("velociraptor","carnivorous","15kg","1.8m","Late Cretaceous");
...
zooAnimals.filter(element => {if(element.population < 5){lowPopulationAnimals.push(element)}} );
...
let initialValue = 0;
populationTotal = zooAnimals.reduce((accumulator, currentValue) => accumulator + currentValue.population, initialValue)
